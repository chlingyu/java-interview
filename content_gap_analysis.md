...
>
> **最后更新**：2026-03-14，P0 缺口全部补齐（Round 1-5），P1 全部补完（Round 6-10），P2 分布式组件补完（Round 11），总题数 159 → 170。
...
| MyBatis | 5~8 | **7** | — | ✅ 达标 |
| 消息队列 | 7~10 | **8** | — | ✅ 达标（+1 P0） |
| 分布式与微服务 | 15~18 | **19** | — | ✅ 达标（+4 P2，Round 11） |
| **总计** | **143~201** | **170** | — | — |
...
| 13 | ~~限流算法（令牌桶/漏桶/滑动窗口）~~ | ~~分布式与微服务~~ Q16 | ✅ 已补 Round 11 |
| 14 | ~~接口幂等性设计（通用版）~~ | ~~分布式与微服务~~ Q19 | ✅ 已补 Round 11 |
...
✅ **P0（7 题）已全部补齐**，**P1（9 题）已全部补完**，**P2 分布式实战组件（4 题）已补完**，总题数 159 → **170 题**，主流高频考点已覆盖。
